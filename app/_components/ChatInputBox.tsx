...
function ChatInputBox() {
  return (
    <div className="relative w-full h-full">
      ...
      {/* Fixed Chat Input  */}
      <div className="absolute z-100 bottom-5 left-0 right-0 mx-auto rounded-3xl w-[50vw] min-h-30 max-h-[336px] overflow-auto dark:bg-neutral-800 shadow-md dark:shadow-neutral-500/50 dark:shadow-lg">
        <Textarea
